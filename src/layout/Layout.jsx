...
const Layout = ({ children, title, loading }) => {
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>{title ?? "Home"} | TeleCommerce </title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="TeleCommerce" />
        <meta
          property="og:description"
          content="E-commerce store built with React, Node, Express and Postgres"
        />
        <meta property="og:site_name" content="TeleCommerce" />
        ...
        <meta
          ...
          content="E-commerce store built with React, Node, Express and Postgres"
        />
        <meta name="twitter:title" content="TeleCommerce" />
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <footer className="mt-auto flex justify-center py-2">
          <p className="text-sm text-gray-600 sm:ml-4 sm:pl-4 sm:py-2 sm:mt-0 mt-4">
            &copy; {new Date().getFullYear()} TeleCommerce 
          </p>
        </footer>
      </div>
    </>
